#ifndef _TEST_FUNC_PARALLEL_HPP
#define _TEST_FUNC_PARALLEL_HPP
...
void cf01 (double *, double *, int , double *,double *, int, int); /* Composition Function 1 */
void cf02 (double *, double *, int , double *,double *, int, int); /* Composition Function 2 */
void cf03 (double *, double *, int , double *,double *, int, int); /* Composition Function 3 */
void cf04 (double *, double *, int , double *,double *, int, int); /* Composition Function 4 */
void cf05 (double *, double *, int , double *,double *, int, int); /* Composition Function 5 */
void cf06 (double *, double *, int , double *,double *, int, int); /* Composition Function 6 */
